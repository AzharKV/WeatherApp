...
class _WeatherState extends State<Weather> {
  ...
  void fetchSearch(String input) async {
    try {
      ...
      errorMessage =
          "Sorry, We Don't Have Data About ${input.toUpperCase()} Or Check The City Name";
    }
  }
  ...
  void fetchLocation() async {
    ...
    var backgroundImage = data["weather_state_name"];
    setState(() {
      temperature = data["the_temp"].round();
      weather = backgroundImage.replaceAll(' ', '').toLowerCase();
